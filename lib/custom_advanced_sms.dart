...
import 'package:custom_advanced_sms/contact.dart';
  ...
  factory SmsReceiver() {
    if (_instance == null) {
      const EventChannel eventChannel =
          EventChannel("plugins.abualzait.com/recvSMS", JSONMethodCodec());
  ...
  factory SmsSender() {
    if (_instance == null) {
      const MethodChannel methodChannel =
          MethodChannel("plugins.abualzait.com/sendSMS", JSONMethodCodec());
      const EventChannel stateChannel =
          EventChannel("plugins.abualzait.com/statusSMS", JSONMethodCodec());
...
class SmsQuery {
  ...
  factory SmsQuery() {
    if (_instance == null) {
      const MethodChannel methodChannel =
          MethodChannel("plugins.abualzait.com/querySMS", JSONMethodCodec());
...
class SmsRemover {
  static const platform = MethodChannel("abualzait.sms.remove.channel");
...
class SimCardsProvider {
  ...
  factory SimCardsProvider() {
    if (_instance == null) {
      const MethodChannel methodChannel =
          MethodChannel("plugins.abualzait.com/simCards", JSONMethodCodec());
