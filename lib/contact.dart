  ...
  factory ContactPhotoQuery() {
    if (_instance == null) {
      const MethodChannel methodChannel = MethodChannel(
          "plugins.abualzait.com/queryContactPhoto", StandardMethodCodec());
  ...
  factory ContactQuery() {
    if (_instance == null) {
      const MethodChannel methodChannel =
          MethodChannel("plugins.abualzait.com/queryContact", JSONMethodCodec());
...
class UserProfileProvider {
  ...
  factory UserProfileProvider() {
    if (_instance == null) {
      const MethodChannel methodChannel =
          MethodChannel("plugins.abualzait.com/userProfile", JSONMethodCodec());
